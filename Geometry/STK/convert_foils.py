...
#@
input_file_name   = "./stk_foils.gdml"
#output_file_name  = "./stk_si_advanced.gdml"
output_file_name  = "./stk_foils_advanced.gdml"
SOLID_BASE_NAME   =  'DAM_TRKAss1_CFRP-FOILS-stl0x2400950'  
#@
#@
#@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
...
for i in xrange(len(lines)):
    ...
    if  triangular_counter == 1 or triangular_counter == total_triangular_lines:
        tmpfile.write(line)
    elif get_z_difference(lines[i-1], lines[i], all_vertices_info) < MAX_FOIL_WIDTH and get_z_difference(lines[i], lines[i+1],all_vertices_info) > MAX_FOIL_WIDTH:
