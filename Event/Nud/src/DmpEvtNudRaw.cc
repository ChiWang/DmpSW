...
void DmpEvtNudRaw::PrintEvent() const{
  std::cout<<"--->  Nud:\tEvent ID = "<<fHeader->GetEventID()<<std::endl;
...
//------------------------------------------------------------------------------
void  DmpEvtNudRaw::PrintEvent(Short_t layer,Short_t bar,Short_t side,Short_t dy){
...
//------------------------------------------------------------------------------
void DmpEvtNudRaw::SetSignal(Int_t LBSD_ID,Double_t ADC){
  fLBSDCollection.push_back(LBSD_ID);
  fADCCollection.push_back(ADC);
}

//------------------------------------------------------------------------------
Int_t DmpEvtNudRaw::CreateLBSDID(Short_t L,Short_t B,Short_t S,Short_t D){
