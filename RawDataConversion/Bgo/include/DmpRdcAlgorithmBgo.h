/*
 *  $Id: DmpRdcAlgorithmBgo.h, 2014-03-09 22:04:35 chi $
 *  Author(s):
...
namespace Rdc{
  namespace Quarter{
bool SetConnector(refer the map,std::string cnctPath){
...
std::cerr<<"\tto "<<std::dec<<fHexData->tellg()<<std::endl;
  ...
  namespace Prototype{
bool SetConnector(refer the map){
}
bool ConvertOneEvent(){
}
  }
...
typedef DmpAlgorithm::Bgo::Rdc  DmpAlgBgoRdc
