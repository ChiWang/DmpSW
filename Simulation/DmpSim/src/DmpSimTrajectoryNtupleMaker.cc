...
void DmpSimTrajectoryNtupleMaker::book(const G4Run* aRun, TTree* aTree)
{ 
...
void DmpSimTrajectoryNtupleMaker::beginEvent(const G4Event* evt)
{
  //set event number
...
void DmpSimTrajectoryNtupleMaker::FillStep(const G4Step* aStep)
{
}

void DmpSimTrajectoryNtupleMaker::FillEvent(const G4Event* evt)
{  
