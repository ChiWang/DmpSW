// *
// * Modified by A.Tykhonov   14/02/2014   - some track information added
// *
...
private:
  ...
  G4double ChrgTrkEnergy;       // total energy of cherged particles in the hit
...
public:
  ...
  inline void AddChrgTrkEnergy(G4double de) { ChrgTrkEnergy += de;};
  ...
  inline G4double GetChrgTrkEnergy() { return ChrgTrkEnergy;};
