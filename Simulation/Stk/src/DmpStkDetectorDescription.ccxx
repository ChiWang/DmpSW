...
void DmpStkDetectorDescription::ParseStkParametersFromGDML(){
	...
	*/
	...
	ConverterThickness      = __StringToDouble(__getAuxGDMLParamter(auxinfo,"ConverterThickness"))*micrometer;
	ThickConverterThickness = __StringToDouble(__getAuxGDMLParamter(auxinfo,"ThickConverterThickness"))*micrometer;
	TKRSiliconThickness     = __StringToDouble(__getAuxGDMLParamter(auxinfo,"TKRSiliconThickness"))*micrometer;
	TKRSiliconTileXY        = __StringToDouble(__getAuxGDMLParamter(auxinfo,"TKRSiliconTileXY"))*cm;//size
	TKRSiliconPitch         = __StringToDouble(__getAuxGDMLParamter(auxinfo,"TKRSiliconPitch"))*micrometer;  //physical pitch
	SiliconGuardRing        = __StringToDouble(__getAuxGDMLParamter(auxinfo,"SiliconGuardRing"))*mm; //guard ring thickness
	NbOfTKRStrips           = __StringToInt(__getAuxGDMLParamter(auxinfo,"NbOfTKRStrips"));
	//ladder geometry
	NbOfTKRTiles            = __StringToInt(__getAuxGDMLParamter(auxinfo,"NbOfTKRTiles"));
	NbOfWTKRTiles           = __StringToInt(__getAuxGDMLParamter(auxinfo,"NbOfWTKRTiles"));
	TilesSeparation         = __StringToDouble(__getAuxGDMLParamter(auxinfo,"TilesSeparation"))*micrometer;
	TKRWRecess              = __StringToDouble(__getAuxGDMLParamter(auxinfo,"TKRWRecess"))*mm;
	//tracker geometry
	TKRLayerDistance        = __StringToDouble(__getAuxGDMLParamter(auxinfo,"TKRLayerDistance"))*cm;
	TKRViewsDistance        = __StringToDouble(__getAuxGDMLParamter(auxinfo,"TKRViewsDistance"))*mm;
	TKRCenterGap            = __StringToDouble(__getAuxGDMLParamter(auxinfo,"TKRCenterGap"))*micrometer;
	NbOfTKRLayers           = __StringToInt(__getAuxGDMLParamter(auxinfo,"NbOfTKRLayers"));
	NbOfTKRBlocks           = __StringToInt(__getAuxGDMLParamter(auxinfo,"NbOfTKRBlocks"));
...
G4String DmpStkDetectorDescription::__getAuxGDMLParamter(G4GDMLAuxListType auxinfo, std::string parameterName){
    ...
    std::cout << "[DmpStkDetectorDescription::__getAuxGDMLParamter] ERROR: parameter "<< parameterName << " mot found in GDML file --> throwing Exception"<<std::endl;
    std::cerr << "[DmpStkDetectorDescription::__getAuxGDMLParamter] ERROR: parameter "<< parameterName << " mot found in GDML file --> throwing Exception"<<std::endl;
    throw;
}
